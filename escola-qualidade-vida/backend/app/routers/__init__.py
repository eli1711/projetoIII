...
def create_app():
    ...
    from app.routers.cadastro import cadastro_bp  # Importando o cadastro_bp
    ...
    app.register_blueprint(cadastro_bp, url_prefix='/alunos')  # Prefixo '/alunos' para cadastro
